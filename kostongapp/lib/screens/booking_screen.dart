// screens/booking_screen.dart - Updated untuk Pencari Kost
...
class _BookingScreenState extends State<BookingScreen> {
  ...
  // Sample rooms data - bisa diganti dengan data dari API
  ...
  int _calculateTotalPrice() {
    final harga =
        int.tryParse(widget.kostData['harga']?.toString() ?? '0') ?? 0;
    return harga * _duration;
  }

  int _calculateDeposit() {
    final harga =
        int.tryParse(widget.kostData['harga']?.toString() ?? '0') ?? 0;
    return harga; // Deposit 1 bulan
  }
    ...
    if (_formKey.currentState!.validate()) {
      if (_selectedRoom == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Silakan pilih kamar terlebih dahulu'),
      ...
      final bookingData = {
        'kost_id': widget.kostData['_id'] ?? widget.kostData['id'],
        'nama_kost': widget.kostData['nama_kost'],
        'alamat': widget.kostData['alamat'],
        'tipe_kamar': widget.kostData['tipe_kamar'],
        'harga': widget.kostData['harga'],
          ...
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        widget.kostData['nama_kost'] ?? 'Nama Kost',
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  'Rp ${widget.kostData['harga']}/bulan',
                  style: const TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
